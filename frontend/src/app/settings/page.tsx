...
const TABS = [
  { value: 'general', label: 'Generelt', icon: Settings2 },
  { value: 'recording', label: 'Opptak', icon: Mic },
  { value: 'Transcriptionmodels', label: 'Transkripsjon', icon: DatabaseIcon },
  { value: 'summaryModels', label: 'Sammendrag', icon: SparkleIcon },
] as const;
