        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h3 className="text-sm font-semibold text-blue-900">
              Tidligere installasjon funnet!
            </h3>
          </div>
          <p className="text-sm text-blue-800 mb-2">
            Vi fant en eksisterende database fra din tidligere installasjon (Python backend-versjon).
          </p>
          <div className="bg-white/50 rounded p-2 mb-3">
            ...
            <p className="text-xs text-blue-600 mt-1">
              Størrelse: {formatFileSize(dbSize)}
            </p>
          </div>
          <p className="text-sm text-blue-800 mb-3">
            Vil du importere dine tidligere møter, transkripsjoner og sammendrag?
          </p>
