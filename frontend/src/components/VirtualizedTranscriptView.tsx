                    ...
                    {isRecording ? (
                        <>
                            ...
                            <p className="text-sm text-gray-600">
                                {isPaused ? 'Opptak satt på pause' : 'Lytter etter tale…'}
                            </p>
                            <p className="text-xs mt-1 text-gray-400">
                                {isPaused ? 'Klikk gjenoppta for å fortsette opptaket' : 'Snakk for å se direktetranskripsjon'}
                            </p>
                        </>
                    ) : (
                        <>
                ...
                <>
                        ...
                        <div ref={loadMoreTriggerRef} className="flex justify-center items-center py-4 mt-2">
                            {isLoadingMore ? (
                                <div className="flex items-center gap-2 text-gray-500">
                                    ...
                                    <span className="text-sm">Laster mer…</span>
                                </div>
                            ) : hasMore && totalCount > 0 ? (
                                <span className="text-sm text-gray-400">
                                    Viser {loadedCount} av {totalCount} segmenter
                                </span>
                            ) : null}
                        </div>
                    )}
                    ...
                    {!isStopping && isRecording && !isPaused && !isProcessing && segments.length > 0 && (
                        ...
                        >
                            ...
                            <span className="text-sm">Lytter…</span>
                        </motion.div>
                    )}
                </>
            ) : (
